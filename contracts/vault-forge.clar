...
;; Mints synthetic stablecoins against deposited Bitcoin collateral
...
;; Adds dual-asset liquidity to the BTC/Stablecoin AMM pool
...
;; Removes liquidity from pool and returns proportional asset shares
...
;; Calculates and returns current collateralization ratio for vault
...
;; Returns current pool state and key metrics
...
;; Retrieves liquidity provider position details and rewards
